...
export const ITEMS: Record<string, Item> = {
  ...
  weapon_sword_wooden: {
    ...
    type: 'weapon',
    slot: 'weapon',
    stats: { damage: 5, speed: 1.2, range: 24 },
    value: 15,
  ...
  weapon_sword_rusty: {
    ...
    type: 'weapon',
    slot: 'weapon',
    stats: { damage: 8, speed: 1.0, range: 26 },
    value: 25,
  ...
  weapon_sword_steel: {
    ...
    type: 'weapon',
    slot: 'weapon',
    stats: { damage: 15, speed: 1.0, range: 28 },
    value: 100,
  ...
  weapon_sword_silver: {
    ...
    type: 'weapon',
    slot: 'weapon',
    stats: { damage: 20, speed: 1.1, range: 28 },
    value: 200,
  ...
  weapon_sword_ruby: {
    ...
    type: 'weapon',
    slot: 'weapon',
    stats: { damage: 30, speed: 1.0, range: 30 },
    value: 500,
  ...
  weapon_sword_golden: {
    ...
    type: 'weapon',
    slot: 'weapon',
    stats: { damage: 25, speed: 0.9, range: 28 },
    value: 400,
  ...
  weapon_dagger_small: {
    ...
    type: 'weapon',
    slot: 'weapon',
    stats: { damage: 4, speed: 1.8, range: 16 },
    value: 10,
  ...
  weapon_dagger_steel: {
    ...
    type: 'weapon',
    slot: 'weapon',
    stats: { damage: 8, speed: 1.6, range: 18 },
    value: 50,
  ...
  weapon_dagger_golden: {
    ...
    type: 'weapon',
    slot: 'weapon',
    stats: { damage: 12, speed: 1.5, range: 18 },
    value: 150,
  ...
  weapon_hammer: {
    ...
    type: 'weapon',
    slot: 'weapon',
    stats: { damage: 22, speed: 0.7, range: 24 },
    value: 180,
  ...
  weapon_sledgehammer: {
    ...
    type: 'weapon',
    slot: 'weapon',
    stats: { damage: 35, speed: 0.5, range: 28 },
    value: 350,
  ...
  weapon_katana_silver: {
    ...
    type: 'weapon',
    slot: 'weapon',
    stats: { damage: 28, speed: 1.3, range: 32 },
    value: 450,
